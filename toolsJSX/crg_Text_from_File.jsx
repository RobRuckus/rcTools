...
// v3.1 removed panel. Windows bug.
// v3.2 replaced deprecated file open with acceptable version which works with CS5 (oops.)
// v3.5 makes 'live leading' more sensible, makes each text layer parented to null for easy positioning (both w/live leading and not)
...
var win = new Window('dialog', 'Text Import Options (v3.5)',[300,100,553,410]);
var w = buildUI();
if (w != null) {
    w.show();
}
